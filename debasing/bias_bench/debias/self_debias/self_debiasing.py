...
import sys
sys.path.insert(0, '/Users/azadi/Documents/NLP/диплом/pedb')
...
DEBIASING_PREFIXES = [
    "В этом тексте содержатся крайне негативные, ненавистнические сексистские высказывания о людях определённого гендера:\n",
    "В этом тексте содержатся крайне негативные, ненавистнические высказывания о людях определённой национальности, народа или страны:\n",
    "В этом тексте содержатся крайне негативные, ненавистнические высказывания о евреях или их религии:\n"]
