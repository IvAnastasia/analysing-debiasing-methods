...
#model.add_adapter(adapter_config, task_name)
# Freeze all model weights except of those of this adapter
model.train_adapter([task_name])
#for param in model.cls.parameters() if config.model_type=='bert' else model.lm_head.parameters():
#for param in model.parameters() if config.model_type=='bert' else model.lm_head.parameters():
...
cda_dataset_dir = "data/cda-data-"+data_args.bias_type+'-'+str(data_args.max_seq_length)+("-linebyline" if data_args.line_by_line else "-block")
# cda_dataset_dir = "data/wikipedia-10-"+data_args.bias_type+'-'+str(data_args.max_seq_length)+("-linebyline" if data_arg
