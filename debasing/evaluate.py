...
from bias_bench.benchmark.rubia import RuBiaRunner
...
if model_args.config_name:
	...
	if model_args.config_overrides is not None:
		print(logger)
		print(model_args.config_overrides)
...
elif data_args.dataset_name=='rubia':
	runner = RuBiaRunner(
		model=model,
		tokenizer=tokenizer,
		input_file=os.path.join('data','rubia','rubia.csv'),
...
#with open(os.path.join(result_dir,'results',f"{data_args.dataset_name}.csv"),"a") as f:
results.to_csv('rubia_results.csv')